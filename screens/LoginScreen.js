...
import BackgroundImage from '../assets/images/Dither-dark-bg.png';
...
export default function LoginScreen({ navigation, route }) {
    ...
    return (
        ...
        // </ImageBackground>
        <ImageBackground source={BackgroundImage} style={styles.backgroundImage}>
            <View style={styles.repeatingTextContainer}>
                <Image source={require('../assets/images/STATIESCAN-outlined.png')} style={styles.headerTextOutline}/>
            </View>
